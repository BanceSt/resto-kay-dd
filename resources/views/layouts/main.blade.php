...
<body>
    <nav class="bg-gray-700 border-gray-200">
        <div class="flex flex-wrap items-center justify-between w-full p-4">
            ...
            @else
            <button onclick="window.location='{{route('register')}}'" type="button" class=" text-2xl py-1.5 px-5 me-2 mb-2 font-medium text-gray-50 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800  dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                Inscription
            </button>
